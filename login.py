...
def signin():
    ...
    if username=='admin' and password=='1234':
        ...
        # Label(screen,text="Hello Everyone",bg="#fff",font=("Time New Roman",50,'bold')).pack(expand=True)
        # screen.mainloop()
        root.destroy()
        import main_Teacher
...
heading=Label(frame,text='Sign in',fg='#57a1f8',bg='white',font=("Time New Roman",23,'bold'))
...
label=Label(frame,text="Don't have an account?",fg='black',bg='white',font=('Time New Roman',9))
label.place(x=75,y=270)


sign_up=Button(frame,width=6,text='Check attendance',border=0,bg='white',cursor='hand1',fg='#57a1f8')
