...
button_dangxuat = tk.Button(windown, text="Đăng xuất", background="#4BF6CE", width=10, borderwidth=2, relief="raised", font=("Arial", 13, "bold"), command=dangxuat)
...
def getSVbyLopHocPhan(event=None):
